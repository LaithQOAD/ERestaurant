...
{
    public sealed class ComboMaterialService : IComboMaterialService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IRequestLanguage _language;

        public ComboMaterialService(IUnitOfWork unitOfWork, IMapper mapper, IRequestLanguage language)
        {
